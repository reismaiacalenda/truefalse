...
@Component({
  selector: 'didatico-simples-form',
  templateUrl: 'didatico-simples-form.component.html'
})
export class DidaticoSimplesFormComponent extends TfFormBaseComponent implements OnInit {
