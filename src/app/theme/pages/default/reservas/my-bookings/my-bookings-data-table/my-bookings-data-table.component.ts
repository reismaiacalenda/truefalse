...
@Component({
  selector: 'my-bookings-data-table',
  templateUrl:'my-bookings-data-table.component.html'
})
export class MyBookingsDataTableComponent extends TfDatatableBase {
  entidade= "reservas";
  defautlQuery="por_meu"
  contentFormModal = {}
