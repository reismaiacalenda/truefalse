...
@Component({
  selector: 'kit-estande-form',
  templateUrl: 'kit-estande-form.component.html'
})
export class KitEstandeFormComponent extends TfFormBaseComponent {
  
  listDadosSelect = {
    // 'funcionarios': [],
    'reservas/list_eventos': [],
    'recursos': []
  }
    ...
    this.subscriptions.add(
      ...
      // consoleLog(response);
        var body = {
          ...
          recalculando: true,
          eventos_estandes_eventos_attributes: JSON.stringify(this.formulario.get('eventos_estandes_eventos_attributes').value),
          kit_estandes_eventos_attributes: null
        }
  ...
  setarPeriodoIndeterminado(){
    if (this.formulario.get('periodo_indeterminado').value == true){
      this.formulario.get('periodo_indeterminado').setValue(false);
      // this.formulario.get('hr_fim_previsto').setValue(this.hr_fim_bkp);
      // this.formulario.get('data_fim').setValue(this.data_fim_bkp);
    }else{
      this.formulario.get('periodo_indeterminado').setValue(true);
