...
@Component({
  selector: 'pessoa-pegar-equipamento',
  templateUrl: 'pessoa-pegar-equipamento.component.html'
})
export class PessoaPegarEquipamentoComponent implements OnInit, AfterViewInit {
