...
@Component({
  selector: 'reserva-estacao-flexivel-form',
  templateUrl: 'reserva-estacao-flexivel-form.component.html'
})
export class ReservaEstacaoFlexivelFormComponent extends TfFormBaseComponent {
  listMesas: any[];
  entidade="reservas";
