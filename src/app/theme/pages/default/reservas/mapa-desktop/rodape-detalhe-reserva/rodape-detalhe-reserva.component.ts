...
export class RodapeDetalheReservaComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  abrirRodape(){
    ...
    this.renderer.removeClass(this.rodape.nativeElement, 'fadeOut');
    this.renderer.addClass(this.rodape.nativeElement, 'fadeIn');
  ...
  fecharRodape(){
    ...
    this.renderer.removeClass(this.rodape.nativeElement, 'fadeIn');
    this.renderer.addClass(this.rodape.nativeElement, 'fadeOut');
    setTimeout(()=>{
