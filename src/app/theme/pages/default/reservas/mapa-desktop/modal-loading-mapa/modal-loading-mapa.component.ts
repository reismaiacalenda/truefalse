...
@Component({
  selector: 'modal-loading-mapa',
  templateUrl: 'modal-loading-mapa.component.html'
})
export class ModalLoadingMapaComponent implements OnInit, AfterViewInit, OnDestroy {
