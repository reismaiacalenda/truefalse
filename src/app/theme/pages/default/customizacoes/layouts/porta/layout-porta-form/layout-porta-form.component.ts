...
@Component({
  selector: 'layout-porta-form',
  templateUrl: 'layout-porta-form.html'
})
export class LayoutPortaFormComponent implements OnInit, AfterViewInit {
  ...
  setarEnumInteracao(){
    switch (this.formulario.value.interacaoEnum) {
      ...
      case 2: this.formulario.value.interacao = "cracha";return;
      case 3: this.formulario.value.interacao = "qrcracha";return;
