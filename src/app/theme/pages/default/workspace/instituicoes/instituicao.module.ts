...
import { InstituicaoDataTableComponent } from './instituicao-data-table/instituicao-data-table.component';
...
const routes: Routes = [
  {
    ...
    "children": [
      {
        path: '', component: InstituicaoComponent, children: [
          { path: 'new', component: InstituicaoFormComponent },
          { path: ':id', component: InstituicaoFormComponent }
        ]
      }
    ]
  }
