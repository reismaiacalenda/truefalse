// import { BaseRequestOptions, RequestMethod, RequestOptions, Response, ResponseOptions, XHRBackend } from "@angular/http";
...
//         // default account
//         if (params.email === 'meeting@calenda.com' && params.password === 'meeting') {
//           filteredUsers[0] = {
//             fullName: 'Meeting',
//             email: 'meeting@calenda.com',
//             password: 'meeting',
//           };
//         }
...
//           connection.mockError(new Error('E-mail e/ou senha inválidos'));
//         }
...
//         }).length;
//         if (duplicateUser) {
//           return connection.mockError(new Error('Email "' + newUser.email + '" já existente.'));
//         }
...
//         } else {
//           // else return 400 bad request
//           connection.mockError(new Error('Usuário inexistente para esse e-mail'));
//         }
...
//   // use fake backend in place of HttpClient service for backend-less development
//   provide: HttpClient,
